...
public class SuperWebBrowser extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        WebEngineSingleton.getInstance().loadContent(myBrowser.getEngine(), new ProxyKids(new WebDataExtractor(),"http://www.example.com"));
        ...
        tf.setOnKeyPressed(new EventHandler<KeyEvent>() {
            ...
            public void handle(KeyEvent ke) {
                if (ke.getCode().equals(KeyCode.ENTER)) {
                    try {
                        WebEngineSingleton.getInstance().loadContent(myBrowser.getEngine(),new ProxyKids( new WebDataExtractor(),tf.getText()));
